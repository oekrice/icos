...
SRCFILES = shared_data.o mpi_tools.o gridpoint_tools.o grid.o import_export.o ops.o main.o
...
mpi_tools.o: mpi_tools.f90 shared_data.o
gridpoint_tools.o: gridpoint_tools.f90 shared_data.o
grid.o: grid.f90 shared_data.o gridpoint_tools.o
import_export.o: import_export.f90 shared_data.o
ops.o: ops.f90 shared_data.o grid.o
main.o: main.f90 shared_data.o grid.o mpi_tools.o import_export.o ops.o
